<?php 
  $kd = $_GET['tentang'];
  $query=mysqli_query($koneksi,"SELECT * FROM tentang WHERE id_tentang='$kd'");
  while ($data=mysqli_fetch_array($query)) {
    $kd = $data['id_tentang'];
    $label = $data['nama_tentang'];
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form action="mod/tentang/aksi_edit.php" method="POST" enctype="multipart/form-data">
