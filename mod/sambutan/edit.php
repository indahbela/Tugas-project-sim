<?php 
  $kd = $_GET['sambutan'];
  $query=mysqli_query($koneksi,"SELECT * FROM sambutan WHERE id_sambutan='$kd'");
  while ($data=mysqli_fetch_array($query)) {
    $kd = $data['id_sambutan'];
    $label = $data['nama_sambutan'];
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form action="mod/sambutan/aksi_edit.php" method="POST" enctype="multipart/form-data">
