                      ...
                      <table class="table table-striped table-hover table-bordered" id="sortable-table">
                        ...
                        <?php 
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="adminweb.php?mod=edit&profil=<?php echo $data['id_profil']; ?>" class="btn btn-icon btn-warning"><i class="far fa-edit"></i></a>
                              <a href="<?php echo $admin_url;  ?>mod/profile/hapus.php?profil=<?php echo $data['id_profil']; ?>" onClick="return confirm('Yakin Mo bahapus ini ?');" class="btn btn-icon btn-danger"><i class="fas fa-trash"></i></a>
                            </td>
                          </tr>
                          <?php $no++; }?>
                        </tbody>
